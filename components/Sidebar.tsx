    ...
    >
        ...
        {SECTIONS.map(section => (
          <React.Fragment key={section.title}>
            ...
            {section.items.map(item => {
              ...
              const { Icon } = item;
              const itemClassName = `w-full flex items-center gap-2.5 rounded-xl font-black text-[11px] uppercase tracking-wide cursor-pointer transition-colors ${
      ...
      {flyoutItem && (
        <div
          ...
          style={{ top: flyoutTop }}
        >
          <div className="px-2 py-1.5 text-[9px] font-black uppercase tracking-widest text-slate-400">
            {flyoutItem.label}
          </div>
